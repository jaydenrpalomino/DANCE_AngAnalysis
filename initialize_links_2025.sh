...
cd /data2/lansce/jr2514/DANCE_Analysis_CONFIG/Config
unlink DanceMap.txt
ln -s DanceMap_23Nov15_edited.txt DanceMap.txt
unlink TMatrix.txt
ln -s TMatrix_57Fe.txt TMatrix.txt

#need to link directories in Alpha Calibrator
cd /home/jr2514/DANCE/DANCE_Alpha_Calibrator
...
cd /data2/lansce/jr2514/DANCE_Alpha_Database
...
cd /data2/lansce/jr2514/Calibrations
unlink calib_ideal.dat
ln -s calib_ideal_2018.dat calib_ideal.dat

cd /data2/lansce/jr2514/DANCE_Analysis_CONFIG/Gates
unlink Alpha.dat
...
cd /home/jr2514/DANCE/DANCE_Analysis
#Need to have a stage1.cfg file in here too
unlink stage1.cfg
ln -s /data2/lansce/jr2514/DANCE_Analysis_CONFIG/cfg_files/stage1_Cd114.cfg stage1.cfg

unlink stage0.cfg
ln -s /data2/lansce/jr2514/DANCE_Analysis_CONFIG/cfg_files/stage0_caen2018.cfg stage0.cfg
