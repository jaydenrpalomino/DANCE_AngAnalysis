...
# Jayden R Palomino for Data in 2019
#
####
...
ln -s quadratic_terms_2019.txt quadratic_terms.txt

cd DANCE_Alpha_Database
unlink DANCE_Alpha_Database.root
ln -s DANCE_Alpha_Database_2019.root DANCE_Alpha_Database.root
...
unlink raw_data
ln -s /data/lansce/8317-A/raw_data raw_data
